  ...
  <div class="bg-gray-100">
    <header>
      ...
      >
        <div class="flex items-center">
          ...
          <p class="font-bold text-2xl ml-8 lg:hidden md:hidden" v-if="texte">
    ...
    >
      <div class="flex flex-col">
        ...
        <div
          class="flex items-center bg-white text-vert font-bold rounded py-1 w-20 ml-4 mt-4 justify-center"
        >
          0 FCFA
        </div>
      </div>
    ...
    >
      <div class="modal-dialog mx-auto w-11/12 md:w-2/3 lg:w-1/2 my-12 md:my-24 lg:my-28">
        ...
        >
          <div
            class="modal-header flex-shrink-0 items-center justify-between px-4 py-3 border-b border-gray-200 rounded-t-md"
          >
          ...
          <div class="modal-body relative p-4 flex-1">
            <input
              class="border-none bg-gray-200 focus:ring-vert focus:border-none lg:ml-28 w-full lg:w-96 h-[3rem] px-5 pr-16 rounded-lg text-sm focus:outline-none"
              type="search"
              name="search"
              placeholder="Search"
            />
          ...
          <div
            class="modal-footer flex-shrink-0 flex-wrap items-center justify-end px-4 py-3 border-t border-gray-200 rounded-b-md"
          >
            <button
              type="button"
            ...
            <button
              type="button"
              class="inline-block px-6 py-2.5 bg-vert text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out ml-1"
            >
              Valider
            </button>
          </div>
          ...
          <ul class="text-gray-700">
            ...
            <li class="my-2 py-2 flex">
              ...
              >
                ...
                <g id="SVGRepo_iconCarrier">
                  ...
                  <path d="M64 640h896v64H64zM128 288h768v64H128z" fill="#EAEAEA"></path>
                  <path
            ...
            <li class="my-2 py-2 flex">
              ...
              >
                ...
                ></g>
                <g id="SVGRepo_iconCarrier">
                  <circle style="fill: #ffd15d" cx="256.001" cy="256" r="256"></circle>
                  <path
                    style="fill: #f9b54c"
            ...
            <li class="my-2 py-2 flex">
              ...
              >
                ...
                ></g>
                <g id="SVGRepo_iconCarrier">
                  <path d="M710.3 1002.7H360.2L266 241.2h538.4z" fill="#FFFFFF"></path>
                  <path
