  ...
  <DashLayout>
    <div class="container mx-auto py-4">
      <ul class="flex flex-wrap justify-center mb-4">
        <li class="mr-4 mb-4">
          <a
            class="bg-gray-300 hover:bg-gray-400 rounded-lg py-2 px-4"
            @click="changeLundi"
            >Lundi</a
          >
        </li>
            ...
            <table class="w-full">
              ...
              <tbody>
                <tr v-for="menu in menus">
                  <td
                    v-if="menu.jour_semaine == dayOfWeek.toLowerCase()"
                    class="py-2 px-4 bg-gray-100 border text-center"
                  >
                    {{ menu.jour_semaine }}
                  </td>
                  <td
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <path
                          d="M10.07 2.93a.75.75 0 011.06 0l5 5a.75.75 0 010 1.06l-8.8 8.8a1.5 1.5 0 01-.44.3l-4.14 1.38a.5.5 0 01-.62-.62l1.38-4.14a1.5 1.5 0 01.3-.44l8.8-8.8zm-1.13 2.47l-5 5 1.06 1.06 5-5-1.06-1.06z"
                        />
                      </svg>
                    </button>
                    ...
                    <button class="p-2 rounded-full bg-red-500 hover:bg-red-600">
                      ...
                      >
                        <path
                          fill-rule="evenodd"
                          d="M15.85 4.15a.5.5 0 00-.7 0L10 9.29l-5.15-5.14a.5.5 0 00-.7.7L9.29 10l-5.14 5.15a.5.5 0 00.7.7L10 10.71l5.15 5.14a.5.5 0 00.7-.7L10.71 10l5.14-5.15a.5.5 0 000-.7z"
                          clip-rule="evenodd"
                        />
                      </svg>
                    </button>
