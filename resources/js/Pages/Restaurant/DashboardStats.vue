<template>
    <DashLayout>
        <div class="flex justify-start items-center bg-gray-100 py-4 lg:py-8">
  <div class="text-2xl lg:text-4xl font-bold text-gray-800">
    Les statistiques mensuelles (commandes)
  </div>
</div>

	<!-- Component Start -->
	<div class="flex mt-8  flex-col justify-center items-center w-full max-w-screen-md p-6 pb-6 bg-white rounded-lg shadow-xl sm:p-8">
