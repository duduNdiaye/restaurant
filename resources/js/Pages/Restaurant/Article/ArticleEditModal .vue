...
<div class="fixed z-10 inset-0 overflow-y-auto" v-if="isSubmitted">
  ...
  <button class="px-4 py-2 text-white bg-blue-400 rounded hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"  @click="submit();closeModal()">Modifier</button>
</div>
              </div>
            </form>
          </div>
