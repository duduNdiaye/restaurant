          ...
          <form enctype="multipart/form-data">
            <div class="grid grid-cols-6 gap-6">
              ...
              <div class="col-span-6 sm:col-span-3">
                ...
                >
                  <option value="aliments" v-if="form.categorie == 'aliments'" selected>
                    Aliments
                  </option>
                  <option value="boissons" v-if="form.categorie == 'boissons'" selected>
                    Boissons
                  </option>
                  <option value="desserts" v-if="form.categorie == 'desserts'" selected>
                    Desserts
                  </option>
                  <option value="aliments" v-if="form.categorie != 'aliments'">
                    Aliments
                  </option>
                  <option value="boissons" v-if="form.categorie != 'boissons'">
                    Boissons
                  </option>
                  <option value="desserts" v-if="form.categorie != 'desserts'">
                    Desserts
                  </option>
                </select>
              ...
              <div class="col-span-6 sm:col-span-3">
                <label
                  for="tempsPreparation"
                  class="block text-sm font-medium text-gray-700"
                  >Temps de preparation</label
                >
                <input
                  type="time"
                  name="tempsPreparation"
                  v-model="form.tempsPreparation"
                  id="tempsPreparation"
                  class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                />
              </div>
              ...
              <div class="flex justify-start relative space-x-4 mt-4">
                <button
                  type="button"
                  class="px-4 py-2 text-white bg-red-500 rounded hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                  @click="closeModal"
                >
                  Quitter
                </button>
                <button
                  type="button"
                  class="px-4 py-2 text-white bg-blue-400 rounded hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                  @click="submit()"
                >
                  Modifier
                </button>
